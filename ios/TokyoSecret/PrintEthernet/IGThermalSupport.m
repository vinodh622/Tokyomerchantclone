...
+ (NSData *) imageToThermalData:(UIImage*)image
{
   ...
   // <UIImage:0x600002d7d8c0 named(main: ticket_logo) {328, 178}>
   // <UIImage:0x600003260a20 anonymous {120, 85}>
...
+ (UIImage*)generateQRcode:(NSString*)qrcode
{
    ...
    UIFont *font = [UIFont boldSystemFontOfSize:18];
    CGFloat textwidth = [IGThermalSupport widthOfString:@"Hello" withFont:font];
    UIImage *newImageWithText = [IGThermalSupport drawText:@"Hello" inImage:newImage atPoint:CGPointMake((530 - textwidth)/2, 30 + 20) withFont:(UIFont *)font];
